...
.login {
  ...
  .content {
    ...
    .content_header {
      ...
      dd {
        font: normal normal normal 18px/21px NanumSquareRound;
    ...
    .content_btn_wrap {
      ...
      .sign_btn {
        ...
        width: 100%;
        border-radius: 50px;
        background: #f8e100 0% 0% no-repeat padding-box;
        opacity: 1;
        margin-bottom: 23px;
        font-size: 14px;
        display: flex;
