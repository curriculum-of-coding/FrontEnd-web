<template>
  <div class="curriculum-detail-content">
    <div class="header">
    ...
    <div class="contents">
      ...
      <div class="title">
        <h2>어떤 언어로 시작하는것이 좋을까?</h2>
      </div>
      <div class="contents-description">
        <h3>1. 소개</h3>
        <div>
          이번 강의에서는 개발 언어의 종류와 각각의 장단점에 대해 다룹니다.<br />또한,
          언어별 특징에 따른 특화분야와 언어와 관련된 개발자 커리어 FAQ도
          진행합니다.
        </div>
      </div>
    </div>
